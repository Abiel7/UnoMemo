...
class SpillKort : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyc =
            binding.spillKortRecycler//every  recycler view have to core components one is the adapter  and layoutManager(measures  and positions  item view)
    ...
    /*
     denne metoden kalles hver gang vi ønsker å oppdatere adapteren
    */
    private fun setupGameAgain() {
        ...
        recyc.adapter =
            gameAdappeter  // adapter provides a binding for the data set to the views of the recycler view
        ...
        if (media.flipCards(pos)) {
            nextBtn.setOnClickListener {
                ...
                it.findNavController()
                    .navigate(SpillKortDirections.actionSpillKortToLeaderboardFragment2())
    ...
    private fun searchImages() {
        var searchLayout =
            LayoutInflater.from(requireContext()).inflate(R.layout.searchlayout, null)
